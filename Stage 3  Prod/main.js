...
module.exports.loop = function () {
    ...
    var tower3 = Game.getObjectById('5bda3b3469753761d17e3e5b');
    if(tower3) {
    ...
    if(builders.length < 0) {
        ...
        Game.spawns['Spawn1'].spawnCreep([WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], newName,
            {memory: {role: 'builder'}});
    }
    ...
    if(miners.length < 1) {
        ...
        Game.spawns['Spawn1'].spawnCreep([WORK,WORK,WORK,WORK,WORK,CARRY,MOVE], newName, //!!! add 3 WORK back in here !!! does miner need carry if dumping into container?
            {memory: {role: 'miner'}});
    }
